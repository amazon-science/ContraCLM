...
class STSEval(object):
    ...
    def run(self, params, batcher):
        ...
        for dataset in self.datasets:
            ...
            all_input_1.extend(input1)
            all_input_2.extend(input2)
            ...
            logging.debug('%s : pearson = %.4f, spearman = %.4f, \t nsamples=%d' %
                          (dataset, results[dataset]['pearson'][0],
                           results[dataset]['spearman'][0], len(gs_scores)))
        ...
        results['all'] = {'pearson': {'all': all_pearson[0],
                          ...
                          'sys_scores': all_sys_scores,
                          'nsamples': len(all_input_1),
                          'sent1': all_input_1,
                          'sent2': all_input_2,
                          }
